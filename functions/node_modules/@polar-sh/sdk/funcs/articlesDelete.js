...
exports.articlesDelete = articlesDelete;
 ...
 * Delete an article.
 */
async function articlesDelete(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.ArticlesDeleteRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
