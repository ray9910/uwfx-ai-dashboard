 ...
 * List subscriptions.
 */
async function subscriptionsList(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.SubscriptionsListRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, operations.SubscriptionsListResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        return () => subscriptionsList(client, {
            ...request,
            page: nextPage,
        }, options);
    };
