 ...
 */
async function oauth2Introspect(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.Oauth2IntrospectTokenIntrospectTokenRequest$outboundSchema
    ...
    const [result] = await M.match(M.json(200, components.IntrospectTokenResponse$inboundSchema), M.fail(["4XX", "5XX"]))(response);
    if (!result.ok) {
        return result;
    }
    return result;
