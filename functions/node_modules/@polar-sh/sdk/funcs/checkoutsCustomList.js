...
exports.checkoutsCustomList = checkoutsCustomList;
 ...
 * List checkout sessions.
 */
async function checkoutsCustomList(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.CheckoutsCustomListRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, operations.CheckoutsCustomListResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        return () => checkoutsCustomList(client, {
            ...request,
            page: nextPage,
        }, options);
    };
...
//# sourceMappingURL=checkoutsCustomList.js.map