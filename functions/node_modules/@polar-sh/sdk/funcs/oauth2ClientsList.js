...
exports.oauth2ClientsList = oauth2ClientsList;
 ...
 * List OAuth2 clients.
 */
async function oauth2ClientsList(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.Oauth2ClientsListRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return (0, operations_js_1.haltIterator)(parsed);
    }
    const payload = parsed.value;
    const body = null;
    const path = (0, url_js_1.pathToFunc)("/v1/oauth2/")();
    ...
    const [result, raw] = await M.match(M.json(200, operations.Oauth2ClientsListResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        return () => oauth2ClientsList(client, {
            ...request,
            page: nextPage,
        }, options);
    };
