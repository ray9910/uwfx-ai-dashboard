...
exports.usersLicenseKeysList = usersLicenseKeysList;
 ...
 * List License Keys
 */
async function usersLicenseKeysList(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.UsersLicenseKeysListRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return (0, operations_js_1.haltIterator)(parsed);
    }
    const payload = parsed.value;
    const body = null;
    const path = (0, url_js_1.pathToFunc)("/v1/users/license-keys/")();
    ...
    const [result, raw] = await M.match(M.json(200, operations.UsersLicenseKeysListResponse$inboundSchema, {
        key: "Result",
    }), M.jsonErr(401, errors.Unauthorized$inboundSchema), M.jsonErr(404, errors.ResourceNotFound$inboundSchema), M.jsonErr(422, errors.HTTPValidationError$inboundSchema), M.fail(["4XX", "5XX"]))(response, { extraFields: responseFields });
    if (!result.ok) {
    ...
    const nextFunc = (responseData) => {
        ...
        return () => usersLicenseKeysList(client, {
            ...request,
            page: nextPage,
        }, options);
    };
...
//# sourceMappingURL=usersLicenseKeysList.js.map