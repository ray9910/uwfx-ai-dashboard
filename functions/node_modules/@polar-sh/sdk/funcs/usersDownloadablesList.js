...
exports.usersDownloadablesList = usersDownloadablesList;
 ...
 * List Downloadables
 */
async function usersDownloadablesList(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.UsersDownloadablesListRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return (0, operations_js_1.haltIterator)(parsed);
    }
    const payload = parsed.value;
    const body = null;
    const path = (0, url_js_1.pathToFunc)("/v1/users/downloadables/")();
    ...
    const [result, raw] = await M.match(M.json(200, operations.UsersDownloadablesListResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        return () => usersDownloadablesList(client, {
            ...request,
            page: nextPage,
        }, options);
    };
...
//# sourceMappingURL=usersDownloadablesList.js.map