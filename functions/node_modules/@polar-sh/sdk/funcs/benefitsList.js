 ...
 * List benefits.
 */
async function benefitsList(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.BenefitsListRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, operations.BenefitsListResponse$inboundSchema, {
        key: "Result",
