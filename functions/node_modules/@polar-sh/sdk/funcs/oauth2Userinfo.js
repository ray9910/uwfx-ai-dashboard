 ...
 */
async function oauth2Userinfo(client, options) {
    ...
    const [result] = await M.match(M.json(200, operations.Oauth2UserinfoResponseOauth2Userinfo$inboundSchema), M.fail(["4XX", "5XX"]))(response);
    if (!result.ok) {
        return result;
    }
    return result;
