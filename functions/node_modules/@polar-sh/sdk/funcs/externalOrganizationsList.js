...
exports.externalOrganizationsList = externalOrganizationsList;
 ...
 * List external organizations.
 */
async function externalOrganizationsList(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.ExternalOrganizationsListRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return (0, operations_js_1.haltIterator)(parsed);
    }
    const payload = parsed.value;
    const body = null;
    const path = (0, url_js_1.pathToFunc)("/v1/external_organizations/")();
    ...
    const [result, raw] = await M.match(M.json(200, operations.ExternalOrganizationsListResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        return () => externalOrganizationsList(client, {
            ...request,
            page: nextPage,
        }, options);
    };
