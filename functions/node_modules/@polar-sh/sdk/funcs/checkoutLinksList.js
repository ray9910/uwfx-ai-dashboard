 ...
 * List checkout links.
 */
async function checkoutLinksList(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.CheckoutLinksListRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, operations.CheckoutLinksListResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        return () => checkoutLinksList(client, {
            ...request,
            page: nextPage,
        }, options);
    };
