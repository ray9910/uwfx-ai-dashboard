 ...
 * List repositories.
 */
async function repositoriesList(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.RepositoriesListRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return (0, operations_js_1.haltIterator)(parsed);
    }
    const payload = parsed.value;
    const body = null;
    const path = (0, url_js_1.pathToFunc)("/v1/repositories/")();
    ...
    const [result, raw] = await M.match(M.json(200, operations.RepositoriesListResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        return () => repositoriesList(client, {
            ...request,
            page: nextPage,
        }, options);
    };
