 ...
 * List organizations.
 */
async function organizationsList(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.OrganizationsListRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, operations.OrganizationsListResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        return () => organizationsList(client, {
            ...request,
            page: nextPage,
        }, options);
    };
