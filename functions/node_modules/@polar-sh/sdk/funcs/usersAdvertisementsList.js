...
exports.usersAdvertisementsList = usersAdvertisementsList;
 ...
 */
async function usersAdvertisementsList(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.UsersAdvertisementsListRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, operations.UsersAdvertisementsListResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        return () => usersAdvertisementsList(client, {
            ...request,
            page: nextPage,
        }, options);
    };
...
//# sourceMappingURL=usersAdvertisementsList.js.map