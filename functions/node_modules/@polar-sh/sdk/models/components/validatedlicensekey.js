...
exports.ValidatedLicenseKey$ = exports.ValidatedLicenseKey$outboundSchema = exports.ValidatedLicenseKey$inboundSchema = void 0;
...
/** @internal */
exports.ValidatedLicenseKey$inboundSchema = z.object({
    id: z.string(),
    ...
    activation: z.nullable(licensekeyactivationbase_js_1.LicenseKeyActivationBase$inboundSchema).optional(),
}).transform((v) => {
...
/** @internal */
exports.ValidatedLicenseKey$outboundSchema = z.object({
    id: z.string(),
    ...
    activation: z.nullable(licensekeyactivationbase_js_1.LicenseKeyActivationBase$outboundSchema).optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var ValidatedLicenseKey$;
(function (ValidatedLicenseKey$) {
    /** @deprecated use `ValidatedLicenseKey$inboundSchema` instead. */
    ValidatedLicenseKey$.inboundSchema = exports.ValidatedLicenseKey$inboundSchema;
    /** @deprecated use `ValidatedLicenseKey$outboundSchema` instead. */
    ValidatedLicenseKey$.outboundSchema = exports.ValidatedLicenseKey$outboundSchema;
})(ValidatedLicenseKey$ || (exports.ValidatedLicenseKey$ = ValidatedLicenseKey$ = {}));
