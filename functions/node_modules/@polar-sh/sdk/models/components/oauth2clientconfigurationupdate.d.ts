...
export declare const OAuth2ClientConfigurationUpdateResponseTypes: {
    readonly Code: "code";
};
export type OAuth2ClientConfigurationUpdateResponseTypes = ClosedEnum<typeof OAuth2ClientConfigurationUpdateResponseTypes>;
export type OAuth2ClientConfigurationUpdate = {
    ...
    responseTypes?: Array<OAuth2ClientConfigurationUpdateResponseTypes> | undefined;
...
/** @internal */
export declare const OAuth2ClientConfigurationUpdateResponseTypes$inboundSchema: z.ZodNativeEnum<typeof OAuth2ClientConfigurationUpdateResponseTypes>;
/** @internal */
export declare const OAuth2ClientConfigurationUpdateResponseTypes$outboundSchema: z.ZodNativeEnum<typeof OAuth2ClientConfigurationUpdateResponseTypes>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace OAuth2ClientConfigurationUpdateResponseTypes$ {
