...
exports.FileDownload$ = exports.FileDownload$outboundSchema = exports.FileDownload$inboundSchema = void 0;
const z = __importStar(require("zod"));
const primitives_js_1 = require("../../lib/primitives.js");
const fileservicetypes_js_1 = require("./fileservicetypes.js");
const s3downloadurl_js_1 = require("./s3downloadurl.js");
/** @internal */
exports.FileDownload$inboundSchema = z.object({
    id: z.string(),
    ...
    download: s3downloadurl_js_1.S3DownloadURL$inboundSchema,
...
/** @internal */
exports.FileDownload$outboundSchema = z.object({
    id: z.string(),
    ...
    download: s3downloadurl_js_1.S3DownloadURL$outboundSchema,
    version: z.nullable(z.string()),
    isUploaded: z.boolean(),
    service: fileservicetypes_js_1.FileServiceTypes$outboundSchema,
...
(function (FileDownload$) {
    ...
    FileDownload$.inboundSchema = exports.FileDownload$inboundSchema;
    /** @deprecated use `FileDownload$outboundSchema` instead. */
    FileDownload$.outboundSchema = exports.FileDownload$outboundSchema;
})(FileDownload$ || (exports.FileDownload$ = FileDownload$ = {}));
